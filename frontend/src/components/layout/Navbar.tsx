          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            {user ? (
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <Link
                  to="/dashboard"
                  className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded-full bg-neutral-100 hover:bg-neutral-200 dark:bg-[#111B24] dark:hover:bg-[#141E27] border border-black/10 dark:border-white/10 transition-all"
                >
                  <img
                    src={
                      user.avatar ||
                  ...
                  />
                  <span className="hidden sm:inline text-xs font-medium text-neutral-900 dark:text-white max-w-[90px] truncate">
              ...
              /* If Logged Out: Desktop only (hidden on mobile) */
