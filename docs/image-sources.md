# Payent Catalog Image Sources & Attribution Log
...
## Catalog Item Angle Breakdown & Sources
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Top-down 45-degree profile showing mode dials, red recording button, and hot shoe.
  - `Back`: Rear LCD screen view highlighting articulating display and viewfinder.
  - `Side`: Side connectivity port profile displaying HDMI and dual SD card slots.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Top handle XLR audio attachment profile.
  - `Back`: Rear control layout and tally lights.
  - `3/4 View`: Isometric studio cinema setup.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/sony-fx3-cinema`).
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Closed top lid aluminum shell showcasing Apple emblem.
  - `Back`: Backlid Magic Keyboard and Force Touch trackpad close-up.
  - `Side`: Side profile showing MagSafe 3, Thunderbolt 4, and HDMI ports.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Closed silver top lid with Dell circle emblem.
  - `Keyboard`: Black carbon fiber palm rest & keyboard deck close-up.
  - `Side`: Ultra-thin side profile showing USB-C ports.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Keyboard`: TrackPoint red navigation nub & keyboard deck close-up.
  - `Top`: Matte black top lid with red LED ThinkPad dot.
  - `Side`: Slim side profile showing Thunderbolt 4 ports.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Keyboard`: WASD gaming keyboard deck close-up.
  - `Top`: AniMe Matrix LED top lid design.
  - `Side`: Side cooling vents and HDMI port profile.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Minimalist HP logo top lid.
  - `Keyboard`: Bang & Olufsen speaker grilles & keyboard.
  - `360 Mode`: Flipped 360-degree tablet mode with stylus.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/hp-spectre-x360`).
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Extended quadcopter flight profile with carbon fiber propellers.
  - `Remote`: Smart Remote Controller with HD display.
  - `Side`: Compact folded side profile in travel hardcase.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/dji-mavic-3`).
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Dual 140W USB-C & USB-A ports angle.
  - `Side`: Textured aluminum casing profile.
  - `Charging`: Connected fast-charging cable view.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Ports`: Triple USB output ports angle.
  - `Side`: LED emergency flashlight profile.
  - `Back`: Input specification label view.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: 18W fast charging ports angle.
  - `Side`: Power check button profile.
  - `Back`: Safety certification label view.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Top`: Dual super-fast output ports.
  - `Side`: Compact palm-sized profile.
  - `Back`: Battery indicator view.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/urbn-20k`).
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Front`: Chrome teardrop fuel tank & engine view.
  - `Headlight`: Round vintage LED headlight view.
  - `Speedo`: Analog speedo instrument cluster dial.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Front`: Aggressive dual LED headlight assembly.
  - `Engine`: 373cc liquid-cooled engine view.
  - `Dash`: Digital TFT dashboard display.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Front`: Front visor & apron LED light.
  - `Seat`: Underseat storage & seat area angle.
  - `Back`: Tail lamp & rear grab rail.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Front`: RockShox front suspension fork.
  - `Cockpit`: Handlebar & hydraulic disc brake levers.
  - `Drivetrain`: 1x10 Shimano drivetrain & rear derailleur.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/trek-marlin-7`).
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Side`: Rubber ergonomic grip profile.
  - `Top`: Mode selector dial angle.
  - `Case`: Carrying case & bit set view.
...
- **Angles Sourced (4 Angles)**:
  ...
  - `Side`: Yellow/black rubberized body side view.
  - `Battery`: 20V MAX 5.0Ah lithium battery pack.
  - `Charger`: Fast charging dock & belt hook.
- **Source & License**: Sourced under Unsplash Open Commercial License (`https://unsplash.com/photos/dewalt-drill`).
