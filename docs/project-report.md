...
| Contact & Inquiries             | `POST /api/contact` persisted to MySQL `support_tickets` & Admin Support Desk | Real   |
| **P2P Rental Chat**             | `GET/POST /api/conversations/*`, WebSocket `/api/conversations/{id}/ws`      | Real   |
