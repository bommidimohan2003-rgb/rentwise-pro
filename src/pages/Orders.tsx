      ...
      <div className="mt-8 card-premium overflow-hidden">
        ...
        {orders.map((o) => (
          ...
          >
            ...
            <span
              className={`text-xs px-2 py-1 rounded-full w-fit ${o.status === "active" ? "bg-emerald-500/10 text-emerald-600" : o.status === "pending" ? "bg-amber-500/10 text-amber-600" : o.status === "cancelled" ? "bg-destructive/10 text-destructive" : "bg-secondary text-muted-foreground"}`}
            >
              {o.status}
            </span>
          </div>
