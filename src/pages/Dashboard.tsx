                ...
                .map((o) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full ${o.status === "active" ? "bg-emerald-500/10 text-emerald-600" : o.status === "pending" ? "bg-amber-500/10 text-amber-600" : "bg-secondary text-muted-foreground"}`}
                      >
                        {o.status}
                      </span>
                    </div>
