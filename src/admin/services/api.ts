...
const INITIAL_PRODUCTS: AdminProduct[] = [
  ...
  },
  {
    ...
    description:
      "Monster video editing laptop with 16-core GPU, 2TB SSD, and Liquid Retina XDR display.",
    category: "Laptops",
    price: 1800,
    rating: 4.8,
    reviewsCount: 31,
  ...
  },
  {
    ...
    description:
      "Compact 6K Super35 cinema camera with global shutter and RF mount for Hollywood productions.",
    category: "Cameras",
    price: 3500,
    rating: 4.9,
    reviewsCount: 15,
  ...
  },
  {
    ...
    description:
      "Industry-standard shotgun microphone with Rycote blimp and boom pole for field audio.",
    category: "Audio",
    price: 1200,
    rating: 4.7,
    reviewsCount: 12,
  ...
  },
  {
    ...
    description:
      "Ultra-bright 600W point-source LED light with Sidus Link app control and weather resistance.",
    category: "Cameras",
    price: 2900,
    rating: 4.8,
    reviewsCount: 9,
    ...
    images: [
      "https://images.unsplash.com/photo-1517430816045-df4b7dec1d5d?w=600",
    ],
    documents: [],
  ...
  },
  {
    ...
    description:
      "Revolutionary spatial computer with dual 4K micro-OLED displays and M2+R1 dual chips.",
    category: "VR & AR",
    price: 2200,
    rating: 4.9,
    reviewsCount: 22,
...
const INITIAL_REVIEWS: AdminReview[] = [
  {
    ...
    rating: 5,
    comment:
      "Pristine condition camera! Handled our 4K 120fps music video shoot flawlessly. Marcus provided extra batteries too.",
    hidden: false,
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "The RC Pro remote control is incredible. Ultra stable signals over 5km distance. Highly recommended lender!",
    hidden: false,
...
const INITIAL_REPORTS: AdminReport[] = [
  {
    id: "REP-401",
    reason: "Delayed return of secondary lens filter kit",
    evidence: "Lender communication logs and shipping tracking receipt.",
    productId: "p1",
    productTitle: "Sony FX3 Cinema Line Camera",
...
const INITIAL_NOTIFICATIONS: AdminNotification[] = [
  ...
  },
  {
    ...
    message: "Payout of ₹12,600 to Elena Rostova was processed successfully.",
    type: "success",
    read: false,
  ...
  },
  {
    ...
    message:
      "Zero vulnerabilities detected in daily JWT & SSL handshake verification.",
    type: "info",
    read: true,
...
const INITIAL_TICKETS: AdminSupportTicket[] = [
  {
    id: "TK-701",
    subject: "Insurance Coverage details for high-value Cinema Rig",
    category: "Insurance & Safety",
    status: "open",
    priority: "high",
    userName: "Devon Carter",
    userEmail: "devon.carter@creatives.co",
    messages: [
      {
        id: "msg-1",
        sender: "user",
        message:
          "Hi team, does the rental insurance cover accidental lens scratch on location in Goa?",
  ...
  {
    id: "TK-702",
    subject: "Indiranagar pickup hub address verification",
    category: "Logistics",
    status: "resolved",
    priority: "medium",
    userName: "Priya Sharma",
    userEmail: "priya.sharma@studios.in",
    messages: [
      {
        id: "msg-2",
        sender: "user",
        message:
          "Could you confirm the exact 100ft road pickup timing on Sunday?",
      ...
      },
      {
        ...
        sender: "admin",
        message:
          "Hi Priya! Our Indiranagar hub is open from 8:00 AM to 9:00 PM every day.",
...
const INITIAL_LOGS: AdminActivityLog[] = [
  ...
  {
    id: "LOG-2",
    timestamp: "2026-08-09T16:31:00Z",
    userName: "Bommidi Mohan",
    action: "Approved Product: Sony FX3 Cinema Line Camera",
    module: "Catalog",
    ipAddress: "127.0.0.1",
  },
  {
    ...
    userName: "Bommidi Mohan",
    action: "Processed Razorpay Settlement #PAY-9902",
    module: "Payments",
    ipAddress: "127.0.0.1",
  },
];
    ...
    if (isNetworkError) {
      ...
      try {
        ...
        if (
          ...
          return Promise.reject({
            response: { status: 404, data: { message: "Review not found" } },
          });
        }
