...
const INITIAL_REVIEWS: AdminReview[] = [
  {
    ...
    rating: 5,
    comment: "Pristine condition camera! Handled our 4K 120fps music video shoot flawlessly. Marcus provided extra batteries too.",
    hidden: false,
  ...
  },
  {
    ...
    rating: 5,
    comment: "The RC Pro remote control is incredible. Ultra stable signals over 5km distance. Highly recommended lender!",
    hidden: false,
...
const INITIAL_NOTIFICATIONS: AdminNotification[] = [
  {
    ...
    message: "Devon Carter listed 'Aputure LS 600d Pro Daylight LED' for ₹2,900/day.",
    type: "warning",
    read: false,
  ...
  },
  {
    ...
    message: "Zero vulnerabilities detected in daily JWT & SSL handshake verification.",
    type: "info",
    read: true,
    ...
    messages: [
      {
        id: "msg-1",
        sender: "user",
        message: "Hi team, does the rental insurance cover accidental lens scratch on location in Goa?",
    ...
    messages: [
      {
        id: "msg-2",
        sender: "user",
        message: "Could you confirm the exact 100ft road pickup timing on Sunday?",
        createdAt: "2026-08-07T14:20:00Z",
      },
      {
        id: "msg-3",
        sender: "admin",
        message: "Hi Priya! Our Indiranagar hub is open from 8:00 AM to 9:00 PM every day.",
...
const getDB = <T>(key: string, initial: T): T => {
  ...
  if (data) {
    try {
      ...
      if (typeof parsed === "object" && parsed !== null && !Array.isArray(parsed) && Object.keys(parsed).length > 0) return parsed as T;
    } catch {
      // fallback
    }
  }
