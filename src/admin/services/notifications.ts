...
export const notificationsService = {
  ...
  async getSettings(): Promise<AdminSettings> {
    ...
    return {
      ...
      seoDescription: "Rent professional video gear, cameras, laptops, drones, and consoles. Safe, secure, and fully insured.",
  ...
  async getDashboardStats(): Promise<DashboardStats> {
    try {
      ...
      console.warn("Failed to fetch backend stats, using client database:", err);
    }
    return {
      totalUsers: 14,
      totalAgents: 3,
