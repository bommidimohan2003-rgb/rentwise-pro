...
import { Eye, EyeOff, Lock, Mail, Loader2, ArrowRight, User, KeyRound, ShieldCheck } from "lucide-react";
          ...
          {mode === "login" && (
            <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="rememberMe" className="ml-2 text-xs font-semibold text-muted-foreground select-none">
